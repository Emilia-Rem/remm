...
public class EmailUtils {
	public static void sendEmail(User user){
		//发送方
		String myAccount = "mountainrabbit@163.com";
		//授权码
		String myPass = "MBMZRUIWAREYOGVJ";
		//发件人 邮箱的 SMTP 服务器地址
	...
	private static MimeMessage createMsg(Session session, String myAccount, User user) {
		...
		try {
			...
			String url = "http://"+ip+":8080/user?method=activate&u="+Base64Utils.base64Encode(user.getUsername())+"&e="+ Base64Utils.base64Encode(user.getEmail())+"&c="+Base64Utils.base64Encode(user.getCode());
