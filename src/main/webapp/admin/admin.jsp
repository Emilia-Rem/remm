		...
		<div class="page_main">
			<script type="text/javascript">
                ...
                $("#invalid").click(function(){
                    $(".dv_content").attr("src","${pageContext.request.contextPath}/admin/inUserList.jsp");
                })
				$("#showGoodsType").click(function(){
					$(".dv_content").attr("src","${pageContext.request.contextPath}/manageGoods?method=getGoodsType&flag=show");
				})
				$("#addGoodsType").click(function(){
					$(".dv_content").attr("src","${pageContext.request.contextPath}/manageGoods?method=getGoodsType&flag=add");
				})
				$("#showGoods").click(function(){
					$(".dv_content").attr("src","${pageContext.request.contextPath}/manageGoods?method=getGoodsList");
				})
				$("#addGoods").click(function(){
					$(".dv_content").attr("src","addGoods.jsp");
				})
				$("#showOrder").click(function(){
					$(".dv_content").attr("src","${pageContext.request.contextPath}/manageOrder?method=getAllOrder");
				})
			</script>
